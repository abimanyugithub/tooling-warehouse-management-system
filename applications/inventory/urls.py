...
urlpatterns = [
    ...
    path('inventory/product/type/list/', views.ListProductType.as_view(), name='product_type_list'),
    path('inventory/product/type/create/', views.CreateProductType.as_view(), name='product_type_create'),
    path('inventory/product/type/detail/<uuid:pk>/', views.DetailProductType.as_view(), name='product_type_detail'),
    path('inventory/product/type/update/<uuid:pk>/', views.UpdateProductType.as_view(), name='product_type_update'),
